...
const STREAM_PROFILES = {
  realtime: {
    ...
    width: 448,
    height: 252,
    summary: 'Realtime mode prioritizes maximum returned FPS with lighter detection cadence, smaller processing resolution, and no enhancement overhead.',
  },
  quality: {
    label: 'Quality',
    sendFps: 10,
